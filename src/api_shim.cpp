 ...
 **************************************************************************/
#ifdef __WINDOWS__
#pragma message("api-shim: __WINDOWS__, including windows.h")
#include <windows.h>
#else
#pragma message("spi_shomer: __WINDOWS__ not defined (!)")
#endif

#ifdef wxUSE_UNICODE_WCHAR
#pragma message(" wxUSE_UNICODE_WCHAR is set")
#else
#pragma message(" wxUSE_UNICODE_WCHAR is not set")
#endif
