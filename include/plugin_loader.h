 ...
 *
 * The general usage pattern to process events, here using EVT_FOO:
 *
 *   wxDEFINE_EVENT(EVT_FOO, wxCommandEvent);
 *   PluginLoader::getInstance()->evt_load_plugin.listen(this, EVT_FOO)
...
class PluginLoader {
public:
  ocpn::EventVar evt_blacklisted_plugin;
  ocpn::EventVar evt_deactivate_plugin;
  ocpn::EventVar evt_incompatible_plugin;
  ocpn::EventVar evt_load_directory;
  ocpn::EventVar evt_load_plugin;
  ocpn::EventVar evt_plugin_unload;
  ocpn::EventVar evt_pluglist_change;
  ocpn::EventVar evt_unreadable_plugin;
  ocpn::EventVar evt_update_chart_types;
  ocpn::EventVar evt_version_incompatible_plugin;
